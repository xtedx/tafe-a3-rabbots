...
namespace Game.Scripts
{
    ...
    /// <summary>
    /// almost identical to the sample script from mirror
    /// just to add more info about the game to the clients
    /// </summary>
    public class MyNetworkDiscovery : NetworkDiscoveryBase<ServerRequest, ServerResponse>
    {
        #region Server
